...
const ProductModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'unitValueInCents': PropertySchema(
      id: 1,
      name: r'unitValueInCents',
      type: IsarType.long,
    )
  },
...
void _productModelSerialize(
  ...
  writer.writeLong(offsets[1], object.unitValueInCents);
}
...
ProductModel _productModelDeserialize(
  ...
  object.unitValueInCents = reader.readLong(offsets[1]);
  return object;
}
...
extension ProductModelQueryFilter
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterFilterCondition>
      unitValueInCentsEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'unitValueInCents',
        value: value,
      ));
    });
  }
...
extension ProductModelQuerySortBy
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> sortByProductName() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy>
      sortByUnitValueInCents() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unitValueInCents', Sort.asc);
    });
  }

  QueryBuilder<ProductModel, ProductModel, QAfterSortBy>
      sortByUnitValueInCentsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unitValueInCents', Sort.desc);
    });
  }
}
...
extension ProductModelQuerySortThenBy
  ...
  QueryBuilder<ProductModel, ProductModel, QAfterSortBy> thenByProductName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'productName', Sort.asc);
    });
  }
...
extension ProductModelQueryWhereDistinct
  ...
  QueryBuilder<ProductModel, ProductModel, QDistinct> distinctByProductName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductModel, ProductModel, QDistinct>
      distinctByUnitValueInCents() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'unitValueInCents');
    });
  }
}
...
extension ProductModelQueryProperty
  ...
  QueryBuilder<ProductModel, String, QQueryOperations> productNameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'productName');
    });
  }

  QueryBuilder<ProductModel, int, QQueryOperations> unitValueInCentsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'unitValueInCents');
    });
  }
}
